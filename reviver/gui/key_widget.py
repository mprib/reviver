from PySide6.QtWidgets import QApplication, QWidget, QVBoxLayout,QGridLayout, QLabel, QPushButton, QLineEdit, QDialog, QDialogButtonBox
...
class ApiKeyWidget(QWidget):
    def __init__(self, env_location:Path):
        ...
        self.open_router_api_key_label = QLabel('Open Router API Key: ' + self.anonymize_key(getenv('OPEN_ROUTER_API_KEY')))
        self.set_open_router_api_button = QPushButton('Set API Key')

        self.open_ai_api_key_label = QLabel('Open AI API Key: ' + self.anonymize_key(getenv('OPEN_AI_API_KEY')))
    ...
    def connect_widgets(self):
        self.set_open_router_api_button.clicked.connect(self.on_set_open_router_button_clicked)
    ...
    def on_set_open_router_button_clicked(self):
        ...
        if dialog.exec():
            ...
            self.open_router_api_key_label.setText('Open Router API Key: ' + self.anonymize_key(new_key))
    ...
    def on_set_open_ai_button_clicked(self):
        ...
        if dialog.exec():
            ...
            self.open_ai_api_key_label.setText('Open AI API Key: ' + self.anonymize_key(new_key))
